...
public sealed class GachaPanelPresenter : MonoBehaviour
{
    ...
    private void BindButtons()
    {
        if (singleDrawButton != null && subscribedSingleButton != singleDrawButton)
        {
            ...
            subscribedSingleButton.DrawCompleted += ShowDrawResult;
        ...
        if (tenDrawButton != null && subscribedTenButton != tenDrawButton)
        {
            ...
            subscribedTenButton.DrawCompleted += ShowDrawResult;
    ...
    private void ShowDrawResult(GachaDrawResult result)
    {
        if (resultOverlay != null)
        {
            resultOverlay.Show(result, GetHeroName);
        }
        else
        {
